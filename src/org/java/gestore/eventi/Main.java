...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NumeroEventi; i++) {
            ...
            do {
                try {
                    System.out.println("\nInserisci i dettagli dell'evento n." + (i + 1));
                    ...
                    if (title.isEmpty()) {
                        throw new IllegalArgumentException("Il nome dell'evento non può essere vuoto o contenere numeri.");
                    }
        ...
        for (int x = 0; x < listaEventi.size(); x++) {
            ...
            System.out.println("-----------------------------------");
            System.out.println(listaEventi.get(x));
        }
        ...
        if (modificaPrenotazioni) {
            ...
            if (indexEvento >= 0 && indexEvento < listaEventi.size()) {
                ...
                System.out.println("-----------------------------------");
                System.out.println(listaEventi.get(indexEvento));
